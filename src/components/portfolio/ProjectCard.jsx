...
export default function ProjectCard({ project, index, onClick }) {
  return (
    <motion.article
      ...
      className="group bg-white rounded-3xl p-6 shadow-xl shadow-slate-200/50 border border-slate-100 hover:shadow-2xl hover:shadow-blue-100/50 hover:border-blue-200 transition-all duration-300 cursor-pointer focus-within:ring-2 focus-within:ring-blue-500 focus-within:ring-offset-2"
      onClick={onClick}
