...
# postgresql://postgres:wzzEoExNEZpPZNLceqaMwqXqPazdJZvO@yamanote.proxy.rlwy.net:40486/railway
DATABASES = {
    'default': {
...
# In production, Django uses this directory to serve static files
